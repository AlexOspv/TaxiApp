...
import com.alexos.taxiapp.databinding.ActivityDriverMapsBinding;
...
import com.alexos.taxiapp.databinding.ActivityPassengerMapsBinding;
...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookTaxiButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bookTaxiButton.setText("Awaiting your taxi...");
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        switch (statusCode) {
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                String message = "Adjust location setting on your device";
